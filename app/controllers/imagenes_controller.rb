class ImagenesController < ApplicationController
  ...
  Ruta_directorio_imagenes = "app/assets/images/";
  ...
  def subir_imagen
   ...
   if request.post?
      ...
      directorio = Ruta_directorio_imagenes;
      ...
      if extension == ".jpg"
         ...
         redirect_to :controller => "imagenes", :action => "listar_imagen", :subir_archivo => subir_archivo;
      else
  ...
  def listar_imagen
   #Guardamos la lista de archivos de la carpeta "imagenes".
   @archivos = Dir.entries(Ruta_directorio_imagenes);
  ...
  def borrar_imagen
   ...
   ruta_al_archivo = Ruta_directorio_imagenes + archivo_a_borrar;
   ...
   redirect_to :controller => "imagenes", :action => "listar_imagen", :eliminar_archivo => eliminar_archivo;
 end
