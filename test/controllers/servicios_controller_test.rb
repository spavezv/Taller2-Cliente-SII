...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { avance: @servicio.avance, creacion: @servicio.creacion, id_empresa: @servicio.id_empresa, nombre: @servicio.nombre, pagado: @servicio.pagado, precio: @servicio.precio }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { avance: @servicio.avance, creacion: @servicio.creacion, id_empresa: @servicio.id_empresa, nombre: @servicio.nombre, pagado: @servicio.pagado, precio: @servicio.precio }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
